      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-violet-800 mx-2 rounded-full hover:bg-violet-950 disabled:via-violet-700 p-4 py-2 text-sm font-bold text-white"
          >
            Save
          </button>
          </div>
        ...
        <div className="todos">
          {todos.length === 0 && (
            <div className=" my-5 mx-5">No Todos to display</div>
          )}
          {todos.map((item) => {
